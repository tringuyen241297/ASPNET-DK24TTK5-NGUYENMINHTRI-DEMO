...
public partial class CakeshopContext : DbContext
{
    ...
    #warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
            => optionsBuilder.UseSqlServer("Data Source=(localdb)\\ProjectModels;Initial Catalog=Lethanhphong;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HinhanhS__3214EC07D6A11979");

            entity.ToTable("HinhanhSP");

            entity.Property(e => e.HinhAnhPhu).HasMaxLength(50);
            entity.Property(e => e.MaHh).HasColumnName("MaHH");

            entity.HasOne(d => d.MaHhNavigation).WithMany(p => p.HinhanhSps)
                .HasForeignKey(d => d.MaHh)
                .HasConstraintName("FK__HinhanhSP__MaHH__18EBB532");
        });
